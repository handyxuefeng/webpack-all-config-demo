...
let converResult1 = babel.transform(code, {
    ...
    visitor:{
        ArrowFunctionExpression(path){
            ...
            */
            ...
            let body = node.body;
            let generate = node.generate;
            let async =node.async;
            let functionExpression =  t.functionExpression(id, params,body,generate,async);
...
//console.log('converResult1=',converResult1.code);
